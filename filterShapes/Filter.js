  ...
  $(document).ready(function(){
     ...
     $.get(request_url, function(data) {
        ...
        $.each(data, function(index, singleobj) {
              ...
              $('#ss-category').append('<table><tr><td><div class="productsDiv"><div class="imageDiv"><a href="'+prod_url +'" target=_blank><img src="'+full_img_url+'" alt="'+img_obj.title+ '"></a></br></div><div class="nameDiv">'+singleobj.name + '</div><div class ="priceDiv">$' + singleobj.price  + '</div></div></td></tr></table>'); 
		   });  
